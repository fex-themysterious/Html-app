...
## Gotchas
- Cache-busting: `script.js?v=205`, `social.js?v=36`, `style.css?v=131`, `social.css?v=25`, `duel.js?v=2` — increment when making changes; SW cache is `syllabus-tracker-v202`

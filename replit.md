...
## Gotchas
- Cache-busting: `script.js?v=206`, `social.js?v=37`, `style.css?v=132`, `social.css?v=25`, `duel.js?v=2` — increment when making changes; SW cache is `syllabus-tracker-v203`

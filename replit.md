...
## Gotchas
- Cache-busting: `script.js?v=208`, `social.js?v=37`, `style.css?v=134`, `social.css?v=26`, `duel.js?v=3` — increment when making changes; SW cache is `syllabus-tracker-v204`
